 ...
 * @author Leo Ureel
 */
public interface StockAnalyzerInterface2 {
	 ...
	 */
	public abstract ArrayList<AbstractStock> listBySymbolDates ( String symbol, Date startDate, Date endDate );
	 ...
	 */
	public abstract double averageHigh( String symbol, Date startDate, Date endDate ) throws StockNotFoundException;
	 ...
	 * @throws StockNotFoundException
	 */
	public abstract double averageLow( String symbol, Date startDate, Date endDate ) throws StockNotFoundException;
	 ...
	 * @throws StockNotFoundException
	 */
	public abstract double averageVolume( String symbol, Date startDate, Date endDate ) throws StockNotFoundException;
